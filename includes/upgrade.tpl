                    ...
                    <form>
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered mb-0 table-nowrap">
                                ...
                                <tr>
                                    <th scope="row">
                                      <h5 class="font-size-14 text-truncate" style="position: relative;">{$Upgrade.old_host.host}<img style="position: absolute; width:16px; right:20%;top:3px" src="/themes/clientarea/default/assets/images/left-icon.png" /></h5>
                                    </th>
                                    <td>
