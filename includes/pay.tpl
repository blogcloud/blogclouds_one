            ...
            <h4 class="pay-title">
              ...
              {if $Pay.pay_html.type=='url'}
                <h2 style="margin-top:10px">
                    {$ViewBilling.currency.prefix}{$Pay.total} 元
                </h2>
             {/if}
            ...
            {if $Pay.use_credit_limit}
                ...
                <div class="pay-area">
                    ...
                    <div class="par_balance">
                        ...
                        <span class="balance_money" style="color:#1676FE"> {$ViewBilling.currency.prefix}{$Pay.total}元</span>
                    </div>
                    {/if}
                    <!-- 支付成功遮罩层 -->
                    ...
                    {if $Pay.PayStatus!='Paid'}
                        {if $Pay.use_credit==1&&$Pay.credit_enough==1}
                            <div class="par_balance">
                                ...
                                <span class="balance_money"> {$ViewBilling.currency.prefix}{$Pay.total}元</span>
                            </div>
                        {/if}
                    {/if}
